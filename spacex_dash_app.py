...
def get_scatter_chart(selected_site, slider_values):
    ...
    scatter_ = spacex_df[spacex_df['Payload Mass (kg)'].between(low,high)]
    if selected_site == 'ALL':
        fig = px.scatter(scatter_,
        ...
        scatter_ = scatter_df[scatter_df['Launch_site'] == selected_site]
        fig = px.scatter(scatter_df,
                        x='Payload Mass (kg)', y='class',
                        color='Booster Version Category',
                        title='Correlation between Payload and Success for all Sites' + selected_site
                        )
        return fig
# Run the app
